...
**Yellow highlight** = fill-in fields or payment option to select.

## Key terms

- Aircraft: Boeing 737-500 **VQ-BOO** @ JAT Tehnika, Belgrade  
- Total: **USD 24,000** excl. taxes/fees (~2 pages)  
- Default payment: **100% post-payment** (options A/B/C)  
...
> Note: Appendix with parts list is reserved for a future disassembly agreement, not this inspection contract.
